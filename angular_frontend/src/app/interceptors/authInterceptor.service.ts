...
export class AuthInterceptor implements HttpInterceptor {
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    }else if(req.url.includes('signin') || (req.url.includes("send_reset_password_email") && req.method === "POST") || req.url.includes('forgotPassword') || (req.url.includes('settings/theme') && req.method === 'GET')){
