...
//	}
	...
	@ApiResponses({
	    @ApiResponse(responseCode = "200", description = "Accommodation successfully deleted (so HIDDEN)"),
	    @ApiResponse(responseCode = "403", description = "The user who tried to 'delete' the Accommodation was nor the owner nor an admin: only the owners and/or admins of the accommodation can edit its informations. Also it could be that the specified Accommodation has future valid Bookings"),
	    @ApiResponse(responseCode = "404", description = "Accommodation ID not valid")
	})
	@Operation(summary = "This API 'deletes' (it HIDES) the specified Accommodation")
	@PreAuthorize("hasAuthority('USER')")
