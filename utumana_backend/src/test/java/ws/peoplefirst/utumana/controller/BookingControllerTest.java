...
public class BookingControllerTest {
    ...
    void openBookingGuest() {
        ...
        when(bookingService.findAllBookingsDTOById(anyLong())).thenReturn(getInstance(ArrayList.class));
        assertDoesNotThrow(() -> bookingController.openBookingGuest(authentication));
    }

    @Test
    void openBookingGuestKoAuth() {
        when(authentication.getPrincipal()).thenReturn(null);
        assertThrows(TheJBeansException.class, () -> bookingController.openBookingGuest(authentication));
    }
